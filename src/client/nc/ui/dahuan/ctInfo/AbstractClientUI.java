...
import nc.ui.bfriend.button.AgreeBtnVO;
import nc.ui.bfriend.button.CwbhBtnVO;
import nc.ui.bfriend.button.CwqrBtnVO;
import nc.ui.bfriend.button.ConReadBtnVO;
import nc.ui.bfriend.button.NoAgreeBtnVO;
  ...
  public abstract class AbstractClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{
	...
	protected void initPrivateButton() {
		...
		if( hasCancelAudit ){
			...
			btnVo3.setBtnName("撤销");
			addPrivateButton(btnVo3);	
		}
		
		addPrivateButton(new RetCommitBtnVO().getButtonVO());
		addPrivateButton(new CwqrBtnVO().getButtonVO());
		addPrivateButton(new CwbhBtnVO().getButtonVO());
		addPrivateButton(new AgreeBtnVO().getButtonVO());
		addPrivateButton(new NoAgreeBtnVO().getButtonVO());
