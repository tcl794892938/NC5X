...
import nc.ui.bfriend.button.DeliveryCardBtnVO;
import nc.ui.bfriend.button.DeliveryListBtnVO;
import nc.ui.bfriend.button.DeliveryQryBtnVO;
 ...
 */
  public abstract class AbstractClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dahuan.fhzz.MyDelegator();
	}
	...
	protected void initPrivateButton() {
		...
		addPrivateButton(new DeliveryQryBtnVO().getButtonVO());
	}
