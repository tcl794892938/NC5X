...
import nc.ui.bfriend.button.FkzdBtnVO;
 ...
 */
  public abstract class AbstractClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dahuan.fkjh.MyDelegator();
	}
	...
	protected void initPrivateButton() {
		...
		if( hasCancelAudit ){
			...
			btnVo3.setBtnName("驳回");
			addPrivateButton(btnVo3);	
		}	
		
		FkzdBtnVO zdBtn=new FkzdBtnVO();
	      addPrivateButton(zdBtn.getButtonVO());

	      ButtonVO BtnVO7 = new FileUpLoadBtnVO().getButtonVO3();
	      addPrivateButton(BtnVO7);
	      
	      ButtonVO BtnVO8 = new FileUpLoadBtnVO().getButtonVO2();
