 ...
 */
  public abstract class AbstractClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dahuan.fkjhzjl.MyDelegator();
	}
	...
	protected void initPrivateButton() {
		...
		ButtonVO btnPrint = nc.ui.trade.button.ButtonVOFactory.getInstance().build(nc.ui.trade.button.IBillButton.Print);
		btnPrint.setBtnName("绑定");
		addPrivateButton(btnPrint);
	}
