...
//		财务审批
		//非溧阳公司的采购合同都走财务审核(过滤历史合同)
		condition = strWhere.toString() + " and nvl(vbillstatus,0) = 1 " 
		+ " and httype='1' and nvl(is_seal,0)=0 and pk_corp<>'1002' and pk_corp='"+corpid+"' ";
		setListVO();
	}
