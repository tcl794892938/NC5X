...
public class HtksdzPlugin implements IBusinessPlugin {
	...
	public IAlertMessage implementReturnFormatMsg(Key[] keys, String corpPK,
		...
		HtmxReportVO[] itemvos1 = queryAlertHtdz(Condition);

		return new HtksdzAlertMsg(itemvos1);
	}
	...
	private HtmxReportVO[] queryAlertHtdz(String Condition)
			throws BusinessException {

		StringBuffer sql1 = new StringBuffer();
		sql1.append("	select aa.jobcode,aa.jobname,aa.custname,aa.xsj,aa.cgj,aa.ce,aa.sjsk,aa.sjfk,aa.sjfy ,aa.sjml from dh_htalert aa where aa.alertype = 1 and aa.sjml < 0 "
		...
		if (list.size() != 0) {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				ExpenseHTtjVOList.add(expensehtzxVo);
			}
