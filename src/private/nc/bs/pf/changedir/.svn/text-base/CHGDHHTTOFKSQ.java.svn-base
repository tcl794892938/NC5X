 ...
 * 用于DHHTTOFKSQ的VO交换类。
 *
 * @author 流程平台自动产生的VO交换类 2013-10-14
 * @since 5.5
 */
public class CHGDHHTTOFKSQ extends nc.bs.pf.change.VOConversion {
/**
 * CHGDHHTTOFKSQ 默认构造
 */
public CHGDHHTTOFKSQ() {
	super();
}
/**
 * 获得交换后处理类 全名称
...
public String[] getFormulas() {
	return new String[] {
		      ...
		      "B_vsourcebillrowid->B_pk_contract_b"
		  };
}
/**
 * 返回用户自定义函数
