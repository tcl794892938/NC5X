 ...
 */
	...
	public Integer getDjlx() {
			...
			public String getHtupd() {
				return htupd;
			}

			public void setHtupd(String htupd) {
				this.htupd = htupd;
			}
			...
			public UFDouble getLjamt() {
				return ljamt;
			}

			public void setLjamt(UFDouble ljamt) {
				this.ljamt = ljamt;
			}
	 ...
	 */
	 public HtUpdateVO(String newHtupd) {
		// 为主键字段赋值:
		 htupd = newHtupd;
	...
	public UFDouble getBgtmny() {
		return bgtmny;
	}

	public void setBgtmny(UFDouble bgtmny) {
		this.bgtmny = bgtmny;
	}
