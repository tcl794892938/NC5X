...
public class CumandocVO extends SuperVO {
	
	private UFDouble accawmny;		
	private Integer acclimit;	
	private String acclimitcontrol;		
	private String acclmtbegindate;		
	private UFDouble balancemny;		
	private String bp;		
	private UFDouble busawmny;			
	...
	private Integer creditlimitnum;		
	private UFDouble creditmny;			
	private UFDouble creditmoney;			
	private Integer credlimitflag;			
	...
	private Integer stockpriceratio;		
	private UFDouble testsalemoney;		
	private String ts;		
	...
	public UFDouble getAccawmny() {
		return accawmny;
	}

	public void setAccawmny(UFDouble accawmny) {
	...
	public UFDouble getBalancemny() {
		return balancemny;
	}

	public void setBalancemny(UFDouble balancemny) {
	...
	public UFDouble getBusawmny() {
		return busawmny;
	}

	public void setBusawmny(UFDouble busawmny) {
	...
	public void setCreditmny(UFDouble creditmny) {
		this.creditmny = creditmny;
	}

	public UFDouble getCreditmoney() {
		return creditmoney;
	}

	public void setCreditmoney(UFDouble creditmoney) {
		this.creditmoney = creditmoney;
	}

	public Integer getCredlimitflag() {
		return credlimitflag;
	}

	public void setCredlimitflag(Integer credlimitflag) {
	...
	public Integer getInnerctldays() {
		return innerctldays;
	}

	public void setInnerctldays(Integer innerctldays) {
	...
	public UFDouble getOrdawmny() {
		return ordawmny;
	}

	public void setOrdawmny(UFDouble ordawmny) {
	...
	public String getPk_currtype1() {
		return pk_currtype1;
	}

	public void setPk_currtype1(String pk_currtype1) {
		this.pk_currtype1 = pk_currtype1;
	}

	public String getPk_cusmandoc2() {
		return pk_cusmandoc2;
	}

	public void setPk_cusmandoc2(String pk_cusmandoc2) {
		this.pk_cusmandoc2 = pk_cusmandoc2;
	}

	public String getPk_cusmandoc3() {
		return pk_cusmandoc3;
	}

	public void setPk_cusmandoc3(String pk_cusmandoc3) {
		this.pk_cusmandoc3 = pk_cusmandoc3;
	}

	public String getPk_defbusitype() {
		return pk_defbusitype;
	}

	public void setPk_defbusitype(String pk_defbusitype) {
		this.pk_defbusitype = pk_defbusitype;
	}
	...
	public String getPk_pricegroupcorp() {
		return pk_pricegroupcorp;
	}

	public void setPk_pricegroupcorp(String pk_pricegroupcorp) {
		this.pk_pricegroupcorp = pk_pricegroupcorp;
	}

	public String getPk_respdept1() {
		return pk_respdept1;
	}

	public void setPk_respdept1(String pk_respdept1) {
		this.pk_respdept1 = pk_respdept1;
	}

	public String getPk_resppsn1() {
		return pk_resppsn1;
	}

	public void setPk_resppsn1(String pk_resppsn1) {
		this.pk_resppsn1 = pk_resppsn1;
	}

	public String getPk_salestru() {
		return pk_salestru;
	}

	public void setPk_salestru(String pk_salestru) {
		this.pk_salestru = pk_salestru;
	}
	...
	public String getPk_settleunit() {
		return pk_settleunit;
	}

	public void setPk_settleunit(String pk_settleunit) {
		this.pk_settleunit = pk_settleunit;
	}

	public String getPk_stordoc2() {
		return pk_stordoc2;
	}

	public void setPk_stordoc2(String pk_stordoc2) {
		this.pk_stordoc2 = pk_stordoc2;
	}

	public Integer getPrepaidratio() {
		return prepaidratio;
	}

	public void setPrepaidratio(Integer prepaidratio) {
	...
	public Integer getStockpriceratio() {
		return stockpriceratio;
	}

	public void setStockpriceratio(Integer stockpriceratio) {
		this.stockpriceratio = stockpriceratio;
	}

	public UFDouble getTestsalemoney() {
		return testsalemoney;
	}

	public void setTestsalemoney(UFDouble testsalemoney) {
